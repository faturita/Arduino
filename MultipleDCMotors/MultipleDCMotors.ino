...
void loop()
{
  ...
  {
    domotor(myMotor3,spd,BACKWARD);
    domotor(myMotor4,spd,BACKWARD);
  ...
  //domotor(myMotor4);
  delay(1000);
  domotor(myMotor3,0,RELEASE);
  domotor(myMotor4,0,RELEASE);
    domotor(myMotor1,0,RELEASE);
  domotor(myMotor2,0,RELEASE);

  for (spd=0;spd<255;spd++)
  {
    domotor(myMotor3,spd,FORWARD);
    domotor(myMotor4,spd,FORWARD);
